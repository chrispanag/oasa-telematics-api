...
export class APIRequests {
    ...
    public webGetRoutes(lineCode: string, ...params: any[]) {
        return this.requestFunction<IRoute[] | null>(
            API_URL,
            `webGetRoutes&p1=${lineCode}`,
            ...params
        );
    }
    ...
    public webGetStops(routeCode: string, ...params: any[]) {
        return this.requestFunction<IStop[] | null>(
            API_URL,
            `webGetStops&p1=${routeCode}`,
            ...params
        );
    }
    ...
    public webRouteDetails(routeCode: string, ...params: any[]) {
        return this.requestFunction<IRouteDetail[] | null>(
            API_URL,
            `webRouteDetails&p1=${routeCode}`,
            ...params
        );
    }
    ...
    public webRoutesForStop(stopCode: string, ...params: any[]) {
        return this.requestFunction<IRouteOfStop[] | null>(
            API_URL,
            `webRoutesForStop&p1=${stopCode}`,
            ...params
        );
    }
    ...
    public webGetRoutesDetailsAndStops(routeCode: string, ...params: any[]) {
        return this.requestFunction<IRouteDetailsAndStops | null>(
            API_URL,
            `webGetRoutesDetailsAndStops&p1=${routeCode}`,
            ...params
        );
    }
    ...
    public getStopArrivals(stopCode: string, ...params: any[]) {
        return this.requestFunction<IArrival[] | null>(
            API_URL,
            `getStopArrivals&p1=${stopCode}`,
            ...params
        );
    }
    ...
    public getBusLocation(routeCode: string, ...params: any[]) {
        return this.requestFunction<IBusLocation[] | null>(
            API_URL,
            `getBusLocation&p1=${routeCode}`,
            ...params
        );
    }
    ...
    public getScheduleDaysMasterline(lineCode: string, ...params: any[]) {
        return this.requestFunction<IScheduleDay[] | null>(
            API_URL,
            `getScheduleDaysMasterline&p1=${lineCode}`,
            ...params
        );
    }
    ...
    public getSchedLines(mlCode: string, sdcCode: string, lineCode: string, ...params: any[]) {
        return this.requestFunction<ISchedule | null>(
            API_URL,
            `getSchedLines&p1=${mlCode}&p2=${sdcCode}&p3=${lineCode}`,
            ...params
        );
    }
